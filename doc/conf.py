#!/usr/bin/env python
# Copyright (c) 2016 Postmodern Digital.
...
project = u'ftrack connect houdini'
copyright = u'2015, Postmodern Digital'

# Version
with open(
    os.path.join(
        os.path.dirname(__file__), '..', 'source',
        'ftrack_connect_houdini', '_version.py'
    )
) as _version_file:
    _version = re.match(
